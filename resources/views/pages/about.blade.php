...
@section('meta_description', 'We built Rentersmaxx because we lived the problem. International landlords deserve a platform built for them — not an afterthought of a US-only app.')
