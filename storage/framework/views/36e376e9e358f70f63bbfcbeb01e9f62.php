...
<title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — Rentersmaxx</title>
...
<aside class="db-sidebar" id="dbSidebar">
  <div class="db-logo">
    <a href="<?php echo e(url('/')); ?>">Renters<span>maxx</span></a>
  </div>
  <nav class="db-nav">
    <div class="db-nav-section">
      <span class="db-nav-label">Overview</span>
      <a href="<?php echo e(route('dashboard')); ?>" class="db-nav-item <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
        <span class="ni">📊</span> Dashboard
      </a>
    </div>
    <div class="db-nav-section">
      <span class="db-nav-label">Portfolio</span>
      <a href="<?php echo e(route('properties.index')); ?>" class="db-nav-item <?php echo e(request()->routeIs('properties.*') ? 'active' : ''); ?>">
        <span class="ni">🏠</span> Properties
      </a>
      <a href="<?php echo e(route('leases.index')); ?>" class="db-nav-item <?php echo e(request()->routeIs('leases.*') ? 'active' : ''); ?>">
        <span class="ni">📋</span> Leases
      </a>
      <a href="<?php echo e(route('tenants.index')); ?>" class="db-nav-item <?php echo e(request()->routeIs('tenants.*') ? 'active' : ''); ?>">
        <span class="ni">👥</span> Tenants
      </a>
    </div>
    <div class="db-nav-section">
      <span class="db-nav-label">Finance</span>
      <a href="<?php echo e(route('payments.index')); ?>" class="db-nav-item <?php echo e(request()->routeIs('payments.*') ? 'active' : ''); ?>">
    ...
    <div class="db-nav-section">
      ...
      <a href="<?php echo e(route('maintenance.index')); ?>" class="db-nav-item <?php echo e(request()->routeIs('maintenance.*') ? 'active' : ''); ?>">
        <span class="ni">🔧</span> Maintenance
        <?php $openMaintenance = auth()->user()->properties()->with('leases.maintenanceRequests')->get()->flatMap(fn($p) => $p->leases)->flatMap(fn($l) => $l->maintenanceRequests)->where('status','submitted')->count(); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($openMaintenance > 0): ?><span class="db-nav-badge"><?php echo e($openMaintenance); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      </a>
      <a href="#" class="db-nav-item">
  ...
  <div class="db-sidebar-footer">
    <div class="db-user">
      <div class="db-avatar"><?php echo e(strtoupper(substr(auth()->user()->first_name ?? 'U', 0, 1))); ?></div>
      <div>
        <div class="db-user-name"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></div>
...
<div class="db-main">
  <div class="db-topbar">
    <div class="db-topbar-left">
      <span class="db-page-title"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></span>
      <?php if (! empty(trim($__env->yieldContent('breadcrumb')))): ?><span class="db-breadcrumb"><?php echo $__env->yieldContent('breadcrumb'); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
  ...
  <div class="db-content">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
      <div class="db-alert db-alert-success">✓ <?php echo e(session('success')); ?></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
      <div class="db-alert db-alert-error">✗ <?php echo e(session('error')); ?></div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\Users\fxepro\AIProjects\RentersMaxx\resources\views/dashboard/layout.blade.php ENDPATH**/ ?>