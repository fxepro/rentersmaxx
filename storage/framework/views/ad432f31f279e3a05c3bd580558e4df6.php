...
<div class="login-left">
  ...
  <a href="<?php echo e(url('/')); ?>" class="login-logo">Renters<span>maxx</span></a>
  ...
  <div class="login-left-footer">
    <a href="<?php echo e(url('/privacy')); ?>">Privacy</a> · <a href="<?php echo e(url('/terms')); ?>">Terms</a> · <a href="<?php echo e(url('/cookies')); ?>">Cookies</a>
  </div>
</div>
  ...
  <div class="login-card">
    ...
    <div id="signinView">
      <div class="login-card-header">
        <h1>Welcome back.</h1>
        <p>Don't have an account? <a href="<?php echo e(url('/waitlist')); ?>">Join the waitlist →</a></p>
      </div>
      ...
      <form class="login-form" id="loginForm" method="POST" action="<?php echo e(route('auth.login')); ?>">
        <?php echo csrf_field(); ?>
        <div class="form-group">
          <label for="email">Email address</label>
          <input type="email" class="form-input" id="email" name="email" placeholder="you@example.com" autocomplete="email" value="<?php echo e(old('email')); ?>" required>
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="form-error" style="display:block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <div class="login-bottom">
        <p>Not a landlord? <a href="<?php echo e(url('/waitlist')); ?>">Join the waitlist</a> to get started.</p>
...
<?php /**PATH C:\Users\fxepro\AIProjects\RentersMaxx\resources\views/pages/login.blade.php ENDPATH**/ ?>